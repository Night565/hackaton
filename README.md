...
- анализировал разделение ответственности между handler, service/domain и repository;
- проверял работу с версиями онбординга, событиями, прогрессом пользователя и PostgreSQL;
- находил потенциальные ошибки в логике и формулировал замечания для авторов pull request'ов;
- сверял backend-контракты с потребностями frontend;
